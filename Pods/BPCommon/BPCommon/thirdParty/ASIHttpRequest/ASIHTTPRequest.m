...
- (void)releaseBlocksOnMainThread
{
    ...
    if (headersReceivedOnBackgroundThreadBlock) {
        [blocks addObject:headersReceivedOnBackgroundThreadBlock];
        [headersReceivedOnBackgroundThreadBlock release];
        headersReceivedOnBackgroundThreadBlock = nil;
    }
...
- (void)readResponseHeaders
{
	...
	#if NS_BLOCKS_AVAILABLE
    if (headersReceivedOnBackgroundThreadBlock) {
        headersReceivedOnBackgroundThreadBlock([[[self responseHeaders] copy] autorelease]);
    }
    #endif
...
- (void)setHeadersReceivedOnBackgroundThreadBlock:(ASIHeadersBlock)aReceivedBlock
{
    [headersReceivedOnBackgroundThreadBlock release];
    headersReceivedOnBackgroundThreadBlock = [aReceivedBlock copy];
}
